...
AddEventHandler('esx_drugs:hasExitedMarker', function(zone)
	...
	TriggerServerEvent('esx_drugs:stopHarvestLukiCoke')
	TriggerServerEvent('esx_drugs:stopTransformLukiCoke')
	TriggerServerEvent('esx_drugs:stopSellLukiCoke')
	TriggerServerEvent('esx_drugs:stopHarvestLukiMeth')
	TriggerServerEvent('esx_drugs:stopTransformLukiMeth')
	TriggerServerEvent('esx_drugs:stopSellLukiMeth')
	TriggerServerEvent('esx_drugs:stopHarvestLukiWeed')
	TriggerServerEvent('esx_drugs:stopTransformLukiWeed')
	TriggerServerEvent('esx_drugs:stopSellLukiWeed')
	TriggerServerEvent('esx_drugs:stopHarvestLukiOpium')
	TriggerServerEvent('esx_drugs:stopTransformLukiOpium')
	TriggerServerEvent('esx_drugs:stopSellLukiOpium')
	TriggerServerEvent('esx_drugs:stopHarvestLukiAmfa')
	TriggerServerEvent('esx_drugs:stopTransformLukiAmfa')
	TriggerServerEvent('esx_drugs:stopSellLukiAmfa')	
end)
...
-- Kokaina efekt
RegisterNetEvent('esx_drugs:onKoka')
AddEventHandler('esx_drugs:onKoka', function()
	RequestAnimSet("MOVE_M@DRUNK@SLIGHTLYDRUNK")
	while not HasAnimSetLoaded("MOVE_M@DRUNK@SLIGHTLYDRUNK") do
	Citizen.Wait(0)
	end
...
AddEventHandler('esx_drugs:ReturnInventory', function(cokeNbr, cokepNbr, methNbr, methpNbr, weedNbr, weedpNbr, opiumNbr, opiumpNbr, amfaNbr, amfapNbr, jobName, currentZone)
	cokeQTE	   = cokeNbr
		...
		if CurrentAction ~= nil then
			...
			if IsControlJustReleased(0, Keys['E']) then			
				...
				elseif CurrentAction == 'MethField' then
					TriggerServerEvent('esx_drugs:startHarvestLukiMeth')
					TaskStartScenarioInPlace(PlayerPedId(), "PROP_HUMAN_BUM_BIN", 0, false)					
				elseif CurrentAction == 'MethProcessing' then
					TriggerServerEvent('esx_drugs:startTransformLukiMeth')
					TaskStartScenarioInPlace(PlayerPedId(), "PROP_HUMAN_BUM_BIN", 0, false)					
				elseif CurrentAction == 'MethDealer' then
					TriggerServerEvent('esx_drugs:startSellLukiMeth')					
				elseif CurrentAction == 'WeedField' then
					TriggerServerEvent('esx_drugs:startHarvestLukiWeed')
					TaskStartScenarioInPlace(PlayerPedId(), "PROP_HUMAN_BUM_BIN", 0, false)					
				elseif CurrentAction == 'WeedProcessing' then
					TriggerServerEvent('esx_drugs:startTransformLukiWeed')
					TaskStartScenarioInPlace(PlayerPedId(), "PROP_HUMAN_BUM_BIN", 0, false)					
				elseif CurrentAction == 'WeedDealer' then
					TriggerServerEvent('esx_drugs:startSellLukiWeed')
				elseif CurrentAction == 'OpiumField' then
					TriggerServerEvent('esx_drugs:startHarvestLukiOpium')
					TaskStartScenarioInPlace(PlayerPedId(), "PROP_HUMAN_BUM_BIN", 0, false)					
				elseif CurrentAction == 'OpiumProcessing' then
					TriggerServerEvent('esx_drugs:startTransformLukiOpium')
					TaskStartScenarioInPlace(PlayerPedId(), "PROP_HUMAN_BUM_BIN", 0, false)					
				elseif CurrentAction == 'OpiumDealer' then
					TriggerServerEvent('esx_drugs:startSellLukiOpium')
				elseif CurrentAction == 'AmfaField' then
					PackAnim()
					TriggerServerEvent('esx_drugs:startHarvestLukiAmfa')
				elseif CurrentAction == 'AmfaProcessing' then
					TriggerServerEvent('esx_drugs:startTransformLukiAmfa')
					PackAnim()					
				elseif CurrentAction == 'AmfaDealer' then
					TriggerServerEvent('esx_drugs:startSellLukiAmfa')			
				else
					isInZone = false
				end
...
function PackAnim()
	...
	ESX.Streaming.RequestAnimDict(lib, function()
		TaskPlayAnim(PlayerPedId(), lib, animLoop, 100.5, -8.0, -1, 17, 0, false, false, false)		
	end)
